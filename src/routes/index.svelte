	...
	<div class="flex flex-col-reverse items-start sm:flex-row mb-3 border-b-2 border-b-slate-400 dark:border-b-yellow-300">
		<div class="flex flex-col pr-8 mb-3 text-black dark:text-white">
			...
			<p class="text-lg mb-3">
				Software Engineer • Writer • Maker of Things
			</p>
			<div class="flex">
		...
		<div class="flex w-[100px] sm:w-[176px] relative mb-3">
			<img class="shadow-lg rounded-full border border-gray-300" src="/george-photo.jpeg" alt="George Offley" />
		</div>
	</div>
