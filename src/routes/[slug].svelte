...
>
	...
	>
		<p class="flex items-center text-sm text-gray-700 dark:text-gray-300">George Offley</p>
	...
	<div
		class="-mx-4 my-2 flex h-1 w-[100vw] border-b-2 border-b-slate-400 dark:border-indigo-400 sm:mx-0 sm:w-full"
	/>
