...
>
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div
		class="mb-3 flex flex-col-reverse items-start border-b-2 border-b-slate-400 dark:border-indigo-400 sm:flex-row"
	>
		<div class="mb-3 flex flex-col pr-8 text-black dark:text-white">
			<h1 class="mb-3 text-3xl font-bold tracking-tight md:text-5xl">George Offley</h1>
			<p class="mb-3 text-lg">Software Engineer • Writer • Maker of Things</p>
			<div class="flex">
				<svg
				...
				<p class="text-xl font-bold">My Links</p>
			</div>
			<div class="flex space-x-2">
				<!-- Buttons sourced from https://tailwind-elements.com/docs/standard/components/social-buttons/-->
				<button
					type="button"
					data-mdb-ripple="true"
					data-mdb-ripple-color="light"
					class="mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
				...
				>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="h-4 w-4">
						<path
							fill="currentColor"
		...
		<div class="relative mb-3 flex w-[100px] sm:w-[176px]">
			<img
				class="rounded-full border border-gray-300 shadow-lg"
				src="/george-photo.jpeg"
				alt="George Offley"
			/>
		</div>
	</div>
